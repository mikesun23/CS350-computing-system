...
******************* How to run the simulator: *********************
	...
	you need the following main method class to run the simulator:

	TestSimulator.java is uploaded with this file. It can run two

	simulators for both MM1 and MM1K.
...
public class TestSimulator{
	...
	public static void main(String[] args) {
		...
		// give (lambda, Ts, simulation Period)
		FinalSimulator sim = new FinalSimulator(5.0, 0.15, 1000);
		sim.controller();
	}
...
***** important 
the log will be print on the main screen.
...
public class FinalSimulator {
  ...
  //   	out.println("Ts = " + Ts/serviced);
    	...
    	System.out.println("serviced: " + serviced/2);
    	System.out.println("utilization: "+this.lambda*ts/serviced*2);
    	System.out.println("w = " + tw/serviced*this.lambda*2);
    	System.out.println("q = " + 1.0*q/serviced*2);
    	System.out.println("Tw = " + tw/serviced*2);
    	System.out.println("Tq = " + tq/serviced*2);
    	System.out.println("Ts = " + ts/serviced*2);
	}
